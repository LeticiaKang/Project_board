...
import com.fastcampus.mvcboardproject.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @WithUserDetails(value = "unoTest", setupBefore = TestExecutionEvent.TEST_EXECUTION) //username, userDetailsServiceBeanName
